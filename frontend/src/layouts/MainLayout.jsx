...
function MainLayout() {
  ...
  const mainNavItems = [
    { to: "/", label: t("Dashboard"), shortLabel: "D", show: true },
    { to: "/furniture", label: t("Assets"), shortLabel: "A", show: true },
    {
      to: "/furniture/create",
      label: t("Add Asset"),
      shortLabel: "+",
      show: canManageAssets,
    },
  ...
  return (
    <div className="relative min-h-screen bg-[#020817] text-white">
      ...
      <div className="relative z-10 lg:flex">
        <div className="sticky top-0 z-30 px-3 pt-3 sm:px-4 sm:pt-4 lg:hidden">
        ...
        <aside className="hidden lg:flex lg:flex-col lg:justify-between lg:p-4 lg:w-[280px] xl:w-[320px] sticky top-0 h-screen">
